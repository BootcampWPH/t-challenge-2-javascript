# Assignment 2 - Landing Page dengan Tailwind CSS

---

> **Catatan dari Mentor - Henry Rivardo**
>
> Halo! Selamat datang. Minggu lalu kamu sudah berhasil menerjemahkan desain Figma ke dalam HTML dan CSS, itu pencapaian yang bagus.
>
...
Bangun landing page menggunakan **Tailwind CSS**. Tidak boleh ada CSS tradisional sama sekali.
...
Note: jangan lupa untuk update ke main
```
...
- [ ] Tailwind breakpoints (`sm:`, `md:`, `lg:`) digunakan sesuai kebutuhan atau menggunakan clamp agar responsive
- [ ] Kode rapi, indentasi benar, tidak ada kode yang tidak terpakai
- [ ] Project sudah di-push ke GitHub di branch `feat/tailwind` dan jangan lupa update ke main
...
- Selalu gunakan prefix responsif Tailwind: `sm:`, `md:`, `lg:` atau gunakan clamp
